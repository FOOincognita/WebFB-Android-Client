...
namespace NativeCLib
{
    public static class WebFB
    {
        ...
        [DllImport("libCLib", EntryPoint = "createParams")] public static extern IntPtr InitParams([MarshalAs(UnmanagedType.LPStr)] string IP, [MarshalAs(UnmanagedType.LPStr)] string Port); 
